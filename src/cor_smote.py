...
class CorSMOTE(SMOTE):
    ...
    def fit_resample(self, X, y):
        ...
        for minority_class in minority_classes:
            ...
            mi = mutual_info_classif(X, y_ovr, discrete_features=discrete_mask, random_state=self.random_state)
            ...
            stds = np.std(X_minority_values, axis=0)
            stds[stds == 0] = 1.0
                        ...
                        if generated < samples_needed:
                            ...
                            for replacement in [mins, maxs, meds]:
                                if generated < samples_needed:
                                    ...
                                    #noise_scale = 0.01 * np.std(base, axis=0)
                                    #noise = rng.normal(0, noise_scale, base.shape)

                                    new_sample = base.copy() #+ noise
